...
export default function AboutUs() {
    const rawasWorkPillars = [
        " إختيار الموقع من حيث المكان والإطلالة والمساحة والتوزيع الوظيفي بما يعكس مباني مليئة بالحياة متفردة بالشكل والمضمون.",
        "أعلى أنواع الجودة والتي تكمن في التفاصيل الوظيفية والمواد المستخدمة والفهم العميق والدراسة التحليلية للإستخدام العقاري.",
        " خدمة ما بعد البيع من الركائز التي تسعى الشركة لتحقيق فارق ومنافس في خدماتها في هذه المرحلة.",
        "التسليم في الموعد من الركائز التي تسعى الشركة الإلتزام بها وبالجدول الزمني للتنفيذ.",
    ];

    const rawasValues = [
        {
            title: "الكفاءة والإختصاص",
            text: "تسعى شركة رواس الى تقديم كافة الحلول الخاصة في المجالات المختصة بكفاءة من خلال استقطاب طواقم فلسطينية مختصة بكافة المجالات التي تخص قطاع الاستثمار العقاري سواءً في الهندسة والتصميم او الإنشاء او العمل الإداري في المبيعات والتسويق او المجال القانوني الخاص بالعقود الإمتلاك والتملك."
        },
        {
            title: "الأمانة والتجرد",
            text: "يضم هذا المبدئ الجوهر الأساسي للإتقان في أعمال الشركة بحيث تعطي الأمور كما هي بحقها وبمهنية تنبع من واقع يحافظ على الحقوق والواجبات لكافة العاملين والزبائن والمستثمرين"
        },
        {
            title: "الشفافية",
            text: "تسعى الشركة لتقديم نموذج للاستثمار العقاري يعكس المعنى الحقيقي للقدرة العقارية في فلسطين ولتقديم أرقام وأسعار تعكس الفائدة من الاسثمار العقاري"
        },
        {
            title: "الإستدامة والإبتكار",
        ...
        },
        {
            ...
            text: "تؤمن الشركة بإشراك الزبائن في الصفة الوظيفيه لتصميم المبنى المخصص للعمل التجاري والسكني وتطويع هذه المتطلبات وتقديمها في منتجات الشركة من خلال دراسات تسويقية واستبيانات لبعض المشاكل التي تواجه الإستخدام للعقار حسب الوظيفة المطلوبة والشراكة والتعاون مع كافة المؤسسات والشركات والمنظمات التي تسعى لتحقيق بيئة وظيفيه افضل"
        },
        {
            title: "التوعية والثقافة",
            text: "تكرس الشركة جهودها لتقديم كافة المعلومات والأدوات اللازمة لزيادة الوعي بالاستثمار العقاري في السوق الفلسطيني بما يخدم كافة الجهات المعنية وتقديم ودعم قنوات توعوية شابة تعمل على ترسيخ فكرة الاستثمار العقاري الصحيح"
        },
        {
            title: "العمل المجتمعي",
            text: "تؤمن الشركة بضوررة إشتراكها وتقديمها لكافة المساعدات والإشتراك بكافة الفعاليات المجتمعة كدور أساسي في الريادة وتقديم نموذج عالي من الإستثمار والتطوير لكافة طبقات المجتمع الفلسطيني"
        },
    ];
            ...
            <div className="w-full p-6 lg:p-20">
                <section>
                    ...
                    <MotionUpDiv viewportAmount={0.2}>
                        <p className="w-full">
                            تأسست شركة رواس وهي شركة فلسطينية تعنى في قطاع صناعة العقار في عام 2024 وهي شركة مساهمة خصوصية بجهود وتطلعات ورؤية المؤسسين لخلق مفهوم جديد في صناعة
                            العقار
                            الفلسطيني في مدينة رام الله والبيرة وعموم الضفة الغربية مقر الشركة المؤقت في مدينة البيرة البالوع شارع بلازا مول عمارة اسطنبول الطابق الثالث والموقع
                            الدائم
                            عمارة رواس جيت الطابق السادس حي الكرمل مقابل تلفزيون فلسطين برج مشعل في أول مشاريع شركة رواس في رام الله الاستثمارية
                        </p>
                    </MotionUpDiv>
                        ...
                        <MotionUpDiv viewportAmount={0.2} className="relative">
                            <div className="relative flex justify-center items-center">
                                ...
                                <div
                                    ...
                                    <div className="h-1"/>
                                    <p>
                                        نسعى لتكون رواس الخيار الأول في الاستثمار والإمتلاك والتطوير العقاري في فلسطين، وأن تصبح الرائدة في إستقطاب الطاقات
                    ...
                    <MotionUpDiv viewportAmount={0.2}>
                        <div className="flex justify-center w-full">
                            <p className="w-10/12 bg-primary text-primary-foreground p-16 rounded-es-6xl rounded-se-6xl lg:ps-24 lg:rounded-es-full lg:rounded-se-full">
                                تبني شركة رواس من خلال إحتكاكها في رياديي وطاقات المجتمع الفلسطيني قاعدة أساسية في الريادة لتكون الخيار الأول للاستثمار العقاري في فلسطين بصفتها
                                المهنية
                                والوظيفية والطلب الأول لكل باحث عن تطوير عقاري لمنشئته وظيفياً ومعمارياً كما وتسعى لبناء منصة توعوية خاصة بإمتلاك واستثمار العقار في فلسطين
                            </p>
                        </div>
                    </MotionUpDiv>
                        ...
                        <div className="relative">
                            <div className="relative flex justify-center items-center">
                                ...
                                <div
                                    ...
                                    <br/>
                                    <p>
                                        تسعى شركة رواس من خلال إختيارها لمواقع مشاريعها أن تبعث الحياة في المناطق التي تؤسس لاستثمارها فيها لكي تغدو المنطقة أكثر قيمة وحياه وتشغيل
                                        ومن
                                        هنا
                                        جاءت رواس
                                    </p>
                                    ...
                                    <br/>
                                    <p>تهدف الشركة لتحقيق عدة أهداف وركائز في قطاع العقار الفلسطيني</p>
                                    <br/>
                                    <ul className="list-disc ps-5 my-2">
                                        <li>أن تصبح الشركة الواجهة الرئيسية لإستقطاب الطاقات الريادية الشابة الراغبة بالتميز في العمل بالقطاع العقاري في فلسطين لتحقق
                                            الريادة والتفرد في
                                            مشاريعها الخاصة والمشتركة.
                                        </li>
                                        <li>تسعى لتقديم حلول تطويرية لمشاريع عقارية جديدة وأفكار مميزة وتصميمات مبتكرة في قطاع العقاري الفلسطيني.</li>
                                        <li>أن يعيش العملاء تجربة إمتلاك واستثمار عقارية مميزة في جميع مراحلها وخاصة مرحلة ما بعد البيع.</li>
                                        <li>أن تصبح رواس منصة توعوية ومقصد لكل راغب للمعرفة والإستشارة بما يخص القطاع العقاري الفلسطيني.</li>
                                    </ul>
                                    <br/>
                                    <div className="absolute -bottom-12 right-12 z-30 w-20 h-30">
                                        <Image src={pathPrefix + "/icons/qoute-right.svg"} alt="qoute-right" width={82} height={76}/>
                    ...
                    <MotionUpDiv>
                        ...
                        <p>نسعى الى تحقيق أهدافنا من إلتزامنا العميق بركائز الشركة الأربعة</p>
                    </MotionUpDiv>
                    <div className="h-12"/>
                    <div>
                    ...
                    <MotionUpDiv>
                        ...
                        <p>نحن نقدم أعلى مستوى من خدمة العملاء بشفافية ونزاهة كاملة بفريق من المختصين الأكفاء وتتلخص هذه القيم</p>
                    </MotionUpDiv>
                    <div className="h-16"/>
                    <div className="w-full flex flex-wrap justify-around">
