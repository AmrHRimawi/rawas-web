    ...
    return (<div className="w-full flex flex-col justify-between items-center h-lvh">
        <div>
            <div className="bg-primary-foreground p-5 translate-y-28 shadow-2xl border-t-2 rounded-full">
                ...
                <Image width={150} height={150} src="/imgs/rawas-logo.svg" alt="Rawas"/>
            </div>
        </div>
        <div className="w-full flex flex-col justify-center items-center h-3/4 bg-primary-50 text-primary-foreground">
