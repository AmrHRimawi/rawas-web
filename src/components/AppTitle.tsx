...
const AppTitle: React.FC<AppTitleProps> = ({prefix = "", text = "", className, ...props}) => {
    return (<MotionEndDiv>
        <h2 className={"relative text-2xl md:text-4xl lg:text-6xl font-bold after:block after:h-[3px] after:w-28 after:bg-secondary after:mt-2 after:rounded-full after:transition-all after:duration-500 hover:after:w-36 " + className} {...props}>
