...
const projects: Record<number, Project> = {
    1: {
        ...
        properties: [
            {src: `${pathPrefix}/icons/office.svg`, alt: "office", title: "إنطلاق المشروع", text:"2024" },
            {src: `${pathPrefix}/icons/office.svg`, alt: "office", title: "حالة المشروع", text:"مباع بالكامل" },
            {src: `${pathPrefix}/icons/office.svg`, alt: "office", title: "تاريخ التسليم", text:"/2027" },
      ...
      /*  values: [
        ...
        lookImages: [],
         currentImages: [{
            ...
            title: "",
            src: `${pathPrefix}/images/projects/1/current/6.jpg`,
        }],
